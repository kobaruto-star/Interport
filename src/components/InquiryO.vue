...
<template>
  <div class="pa-4 text-center">
    <v-dialog v-model="dialog" max-width="600">
      ...
      <v-card prepend-icon="mdi-account" title="新規問い合わせ">
        <v-card-text>
          <v-row dense>
            <v-col cols="12" md="12" sm="12">
              <v-text-field label="件名" required v-model="inquirysubject"></v-text-field>
            </v-col>
        ...
        <v-card-actions>
          ...
          <v-btn text="閉じる" variant="plain" @click="dialog = false"></v-btn>
